...
import {
  handle_get_lore,
  getLoreSchema,
  handle_get_lore_batch,
  getLoreBatchSchema,
  handle_get_lore_section,
  getLoreSectionSchema,
  handle_list_topics,
  listTopicsSchema,
  handle_list_maps,
  listMapsSchema,
  ...
  handle_search_lore,
  searchLoreSchema,
  handle_validate_topic_exists,
  validateTopicExistsSchema,
} from './system'
import {
  handle_set_lore,
  setLoreSchema,
  ...
  handle_patch_lore,
  patchLoreSchema,
  handle_batch_set_lore,
  batchSetLoreSchema,
  handle_batch_mutate,
  batchMutateSchema,
  handle_restore_lore,
  restoreLoreSchema,
  handle_get_topic_histories,
  getTopicHistoriesSchema,
  handle_increment_topic_field,
  incrementTopicFieldSchema,
...
const ACTION_MAP: Record<string, ActionSpec> = {
  ...
  validate: defineAction(validateTopicExistsSchema, handle_validate_topic_exists, {
    query_string: 'eira-holt',
  }),
  set: defineAction(setLoreSchema, handle_set_lore, {
    key: 'character:eira-holt',
    text: 'Eira Holt is a surgeon...',
  }),
  ...
  batch_mutate: defineAction(batchMutateSchema, handle_batch_mutate, {
    mutations: [
      { key: 'character:eira-holt', action: 'increment', field_path: 'Reputation', increment: 1 },
    ],
  }),
  restore: defineAction(restoreLoreSchema, handle_restore_lore, { key: 'character:eira-holt' }),
  history: defineAction(getTopicHistoriesSchema, handle_get_topic_histories, {
    keys: ['character:eira-holt'],
  }),
