...
import {
  handle_thread_tick,
  threadTickSchema,
  handle_get_relationship,
  getRelationshipSchema,
  handle_get_faction_standing,
  getFactionStandingSchema,
  handle_get_entity_knowledge,
  getEntityKnowledgeSchema,
  handle_set_entity_knowledge,
  setEntityKnowledgeSchema,
  handle_learn_from_event,
  learnFromEventSchema,
  handle_migrate_knowledge,
  migrateKnowledgeSchema,
  handle_get_location_occupants,
  getLocationOccupantsSchema,
  handle_get_reachable_locations,
  getReachableLocationsSchema,
  handle_sense_environment,
  senseEnvironmentSchema,
  handle_get_thread_comparison,
  getThreadComparisonSchema,
  handle_check_convergence,
...
const ACTION_MAP: Record<string, ActionSpec | ToolHandler> = {
  ...
  get_faction_standing: defineAction(getFactionStandingSchema, handle_get_faction_standing, {
    ...
    faction_key: 'faction:guild-of-surgeons',
  }),
  ...
  get_reachable_locations: defineAction(
    getReachableLocationsSchema,
    handle_get_reachable_locations,
    {
