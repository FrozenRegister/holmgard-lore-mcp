...
import { handle_append_event, handle_get_event_log, handle_canonize, handle_migrate_events, handle_recent_changes, handle_tag_topic, handle_find_by_tag, handle_list_tags, handle_bookmark_state, handle_world_diff, handle_plant_setup, handle_pay_off_setup, handle_list_unpaid_setups, handle_set_goal, handle_check_continuity } from './meta'

const ACTION_MAP: Record<string, ToolHandler> = {
  append_event:       handle_append_event,
  get_event_log:      handle_get_event_log,
  canonize:           handle_canonize,
  migrate_events:     handle_migrate_events,
