  ...
  oneOf: [
    ...
    },
    {
      ...
      properties: {
        ...
        entity_name: { type: 'string', minLength: 1, description: 'Alias for entity_key' },
        radius: { type: 'string', description: 'Accepted but currently unused — sense_environment does not compute a radius.' },
      },
      anyOf: [{ required: ['entity_key'] }, { required: ['entity_name'] }],
      additionalProperties: false,
    },
  ...
  oneOf: [
    ...
    },
    {
      ...
      properties: {
        ...
        payoff_type: { type: 'string', description: 'Accepted but currently unused — informational note on the expected payoff category.' },
      },
    ...
    },
    {
      ...
      properties: {
        ...
        severity_floor: {
          ...
          description: 'Minimum severity to report (default: info). low/medium/moderate/high/critical are accepted aliases for info/warn/warn/error/error.',
        },
      },
      additionalProperties: false,
    },
