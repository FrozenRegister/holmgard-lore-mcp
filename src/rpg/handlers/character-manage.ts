...
const ALIASES: Record<string, CharAction> = {
  ...
  switch: 'activate', take_control: 'activate', possess: 'activate', set_driver: 'activate',
  passengers: 'list_passengers', list_dormant: 'list_passengers', co_habitants: 'list_passengers', get_driver: 'list_passengers',
