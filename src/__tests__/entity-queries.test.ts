...
describe('get_relationship', () => {
  it('finds affinity field and cross-references', async () => {
    ...
    const res = await callTool('world_manage', { action: 'get_relationship', entity_a: 'character:alice', entity_b: 'character:bob' })
  ...
  it('returns null relationship and suggestion when no data found', async () => {
    ...
    const res = await callTool('world_manage', { action: 'get_relationship', entity_a: 'character:stranger-a', entity_b: 'character:stranger-b' })
  ...
  it('returns error for missing entity', async () => {
    ...
    const res = await callTool('world_manage', { action: 'get_relationship', entity_a: 'character:exists', entity_b: 'character:no-such' })
...
describe('get_faction_standing', () => {
  it('detects membership when entity name appears in faction text', async () => {
    ...
    const res = await callTool('world_manage', { action: 'get_faction_standing', entity_key: 'character:knight', faction_key: 'faction:order' })
  ...
  it('returns non-member when entity not in faction text', async () => {
    ...
    const res = await callTool('world_manage', { action: 'get_faction_standing', entity_key: 'character:outsider', faction_key: 'faction:order' })
...
describe('get_entity_knowledge', () => {
  it('returns known=true and excerpts when topic appears in text', async () => {
    ...
    const res = await callTool('world_manage', { action: 'get_entity_knowledge', entity_key: 'character:spy', topic: 'secret-vault' })
...
describe('get_location_occupants', () => {
  it('returns entities whose Location field matches', async () => {
    ...
    const res = await callTool('world_manage', { action: 'get_location_occupants', location_key: 'location:barracks' })
  ...
  it('returns empty array when no matches', async () => {
    const res = await callTool('world_manage', { action: 'get_location_occupants', location_key: 'location:empty-room' })
...
describe('get_reachable_locations', () => {
  it('parses Exits field and checks each destination', async () => {
    ...
    const res = await callTool('world_manage', { action: 'get_reachable_locations', origin_key: 'location:hub' })
  ...
  it('returns empty locations when no Exits field', async () => {
    ...
    const res = await callTool('world_manage', { action: 'get_reachable_locations', origin_key: 'location:dead-end' })
...
describe('get_compatibility', () => {
  it('returns compatible=true for well-matched entities', async () => {
    ...
    const res = await callTool('entity_manage', { action: 'get_compatibility', entity_a: 'character:predator-c', entity_b: 'character:prey-c', interaction_type: 'hunt' })
  ...
  it('flags incompatibility when Weight-1 is too low', async () => {
    ...
    const res = await callTool('entity_manage', { action: 'get_compatibility', entity_a: 'character:weak-actor', entity_b: 'character:target', interaction_type: 'consume' })
  ...
  it('returns error for missing entity', async () => {
    ...
    const res = await callTool('entity_manage', { action: 'get_compatibility', entity_a: 'character:exists-only', entity_b: 'character:ghost', interaction_type: 'test' })
    expect(res.error).toBeDefined()
  })
})
