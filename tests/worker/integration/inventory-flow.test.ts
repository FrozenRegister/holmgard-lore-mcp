...
import { handle_entity_manage } from '@/tools/entity-manage'
import { handle_continuity_manage } from '@/tools/continuity-manage'
...
describe('Inventory flow integration', () => {
  ...
  describe('Consumption timelines', () => {
    it('lists consumption timelines', async () => {
      ...
      expect(
        Array.isArray(listBody.result.timelines) || listBody.result.timelines === undefined,
      ).toBeTruthy()
    })
